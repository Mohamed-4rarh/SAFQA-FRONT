...
export const createCountrySchema = yup.object().shape({
  ...
  short_name: yup
    .string()
    .max(255, 'Short name must be less than or equal to 255 letters')
    .required('Short name is required'),
  nationality_en: yup.string().required('English nationality is required'),
  nationality_ar: yup.string().required('Arabic nationality is required'),
  flag: yup
    .mixed()
  ...
  short_currency: yup.string().required('Short Currency is required'),
  country_active: yup.string().required('Please choose country activity'),
});
