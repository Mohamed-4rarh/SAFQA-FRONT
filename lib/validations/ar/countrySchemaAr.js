...
export const createCountrySchemaAr = yup.object().shape({
  name_en: yup
    ...
    .required(' مطلوب الاسم باللغة الإنجليزية'),
  name_ar: yup
    .string()
  ...
  short_name: yup
    .string()
    .max(255, 'يجب أن يكون الاسم المختصر أقل من 255 حرفًا أو مساويًا له')
    .required('الاسم المختصر مطلوب'),
  nationality_en: yup.string().required('جنسية اللغة الإنجليزية مطلوب مجال'),
  nationality_ar: yup.string().required('الجنسية العربية مطلوب مجال'),
  flag: yup
    .mixed()
  ...
  code: yup.string().required('الرمز حقل مطلوب '),
  currency: yup.string().required('العملة مطلوبة'),
  short_currency: yup.string().required('مطلوب حقل العملة القصيرة'),
  country_active: yup.string().required('الرجاء اختيار نشاط الدولة'),
});
...
export const updateCountrySchemaAr = yup.object().shape({
  name_en: yup
    ...
    .max(
      255,
      'يجب أن يكون اسم اللغة الإنجليزية أقل من أو يساوي 255 حرفًا5 حرفًا'
    )
  ...
  short_name: yup
    .string()
    .max(255, 'يجب أن يكون الاسم المختصر أقل من 255 حرفًا أو مساويًا له')
    .required('حقل مطلوب الاسم المختصر'),
  nationality_en: yup.string().required('مطلوب حقل الجنسية الإنجليزية'),
  nationality_ar: yup.string().required('الجنسية العربية مطلوب حقل'),
  flag: yup
    .mixed()
