    ...
    return (
      ...
      >
        <div className="container">
          <div className="row">
            <div
              className={`col-xl-3 col-lg-3 col-md-6 col-sm-6 ${styles.body_footer} safqa-text-primary`}
            >
            ...
            >
              ...
              <br />
              <Link href="/TermsOfUse">{t('links.termsofuse')}</Link>
              <br />
              <Link href="/PrivacyPolicy">{t('links.privacypolicy')}</Link>
              <br />
            </div>
            <div
              className={`col-xl-3 col-lg-3 col-md-6 col-sm-6 ${styles.body_footer}`}
