  ...
  return (
    <div className="container" dir={language == 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className={`row mt-4 ${styles.main}`}>
        ...
        >
          <h1 className="fw-bold mt-5 safqa-text-gradient">
            {t('home.main.h1')}
          </h1>
          ...
          <div className="btns-main mt-5 d-flex">
            <GetItInGP
              className="btnApp pointer px-4"
              label={t('button.getapp')}
            />
            <GetItInAS
              className="btnApp pointer px-4 mx-3"
              // label={t('button.getapp')}
              label={t('button.comming_soon')}
              href="#"
            />
          </div>
          <DotsRectangle />
        ...
        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
          <img
            className={`${styles.bg_image_main} position-absolute ${
              language == 'ar' ? 'img-flip' : ''
            }`}
            src="/home/main/2.png"
            alt="bg"
            width="49%"
