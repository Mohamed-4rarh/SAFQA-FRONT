...
const list_of_contacts_AR = [
  ...
  },
  {
    ...
    src: "./ARE.png",
    head: "الامارات",
    location: "البرشاء - البرشاء 1 - دبي - الإمارات العربية المتحدة",
    emails: ["info@safqapay.com", "support@safqapay.com"],
    phone: "+9743233923212",
    social_links: {
      facebook: "https://facebook.com",
...
const ContactInfo = ({ country, setCountry }) => {
  ...
  const [contact, setContact] = useState(contact_list[1]);
        ...
        >
          <div className="">
            ...
            <h1 className={`${styles.head} safqa-black-color`}>
              {t(`countries.${contact.name.toLowerCase()}`)}
            </h1>
            <div className={`${styles.body} safqa-darkgrey2-color`}>
              ...
              >
                {contact.location && (
                  <>
                    <LocationOnIcon />
                    <p>{t(`locations.${contact.name.toLowerCase()}`)}</p>
                  </>
                )}
              </div>
              <div
