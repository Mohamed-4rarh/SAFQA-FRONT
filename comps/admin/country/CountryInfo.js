...
import { createCountrySchemaAr } from "../../../lib/validations/ar/countrySchemaAr";
...
const CountryInfo = () => {
  ...
  const { countryInfo, isLoading, api_errors, success } = useSelector(
    (state) => state.country
  );
  const defaultValues = countryInfo;
  ...
  const {
    ...
    resolver: yupResolver(language == 'en' ? createCountrySchema : createCountrySchemaAr),
    defaultValues,
  });
  ...
  const onSubmit = (data) => dispatch(createCountry(data));
        ...
        <div className="row">
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 px-4 mt-3">
            <SafqaInput
              ...
              register={register}
              error={
                errors.nationality_en?.message || api_errors?.nationality_en
              }
              required
            />
          </div>
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 px-4 mt-3">
            <SafqaInput
              ...
              required
              error={
                errors.nationality_ar?.message || api_errors?.nationality_ar
              }
            />
          </div>
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 px-4 mt-3">
            <SafqaInput
              ...
              required
              error={
                errors.short_currency?.message || api_errors?.short_currency
              }
            />
          </div>
