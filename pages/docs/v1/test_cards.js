                                            ...
                                            <td className={`${styles.first} safqa_table_padding`}>
                                                {
                                                    data.payment?.items ? <>
                                                        {
                                                            data.payment.items.map(payment => <p key={payment}>{payment}</p>)
                                                        }
                                                    </>
                                                        :
                                                        data.payment
                                            ...
                                            <td className='safqa_table_padding'>
                                                {
                                                    data.numbers?.items ? <>
                                                        {
                                                            data.numbers.items.map(number => <p key={number}>{number}</p>)
                                                        }
                                                    </>
                                                        :
                                                        data.numbers
                                            ...
                                            <td className='safqa_table_padding'>
                                                {
                                                    data.date?.items ? <>
                                                        {
                                                            data.date.items.map(date => <p key={data}>{date}</p>)
                                                        }
                                                    </>
                                                        :
                                                        data.date
                                            ...
                                            <td className='safqa_table_padding'>
                                                {
                                                    data.password?.items ? <>
                                                        {
                                                            data.password.items.map(password => <p key={password}>{password}</p>)
                                                        }
                                                    </>
                                                        :
                                                        data.password
                                            ...
                                            <td className='safqa_table_padding'>
                                                {
                                                    data.result?.items ? <>
                                                        {
                                                            data.result.items.map(result => <p key={result} style={{ width: "300px" }}>{result}</p>)
                                                        }
                                                    </>
                                                        :
                                                        data.result
